...
# 4.Crea un archivo llamado "main.py" y importa el módulo "estadisticas" con la sentencia "import estadisticas"
...
# 4.Crea una función en el archivo "texto.py" llamada "formatear_texto" que reciba una cadena de texto y un formato como argumentos. 
...
# 1.Crea un archivo llamado "validaciones.py" y define una función llamada "validar_email" que reciba una cadena de texto como argumento y retorne verdadero si es una dirección de correo electrónico válida o falso en caso contrario.
